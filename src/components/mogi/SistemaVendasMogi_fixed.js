...
export default function SistemaVendasMogi({ user, darkMode, onClose }) {
  ...
  const carregarDados = async () => {
    try {
      console.log('🔍 Carregando dados Mogi...');
      ...
      console.log('📦 Produtos encontrados:', produtosRes.data?.length || 0);
      console.log('👥 Vendedores encontrados:', vendedoresRes.data?.length || 0);
      console.log('👥 Dados dos vendedores:', vendedoresRes.data);
