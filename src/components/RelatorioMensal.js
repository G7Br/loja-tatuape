...
export default function RelatorioMensal() {
  ...
  const carregarDados = async () => {
    try {
      ...
      console.log('Carregando dados do mês:', inicioMes, 'até', fimMes);
      ...
      const valorTotal = vendas?.reduce((sum, v) => sum + parseFloat(v.valor_final || 0), 0) || 0;
  ...
  return (
    <Container>
      <Header>
        <Title>📊 RELATÓRIO MENSAL - TATUAPÉ</Title>
